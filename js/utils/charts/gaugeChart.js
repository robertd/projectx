define([], function () {
    var GaugeChart = function(data, options) {
        ...
        var gauge = new Gauge(options.selector, config);
        gauge.render();
        gauge.redraw(data.value,2000);
    };
    ...
    var Gauge = function (placeholderName, configuration) {
        ...
        this.render = function(){
            ...
            for (var major = this.config.min; major <= this.config.max; major += majorDelta) {
                ...
                if (major === this.config.min || major === this.config.max) {
                    ...
                    var valuePrefix = d3.formatPrefix(major);
                    var textValue = valuePrefix.scale(major).toFixed()+valuePrefix.symbol;
        ...
        this.redraw = function (value, transitionDuration) {
            ...
            pointerContainer.selectAll("text").text(numberFormater(Math.round(value)));
